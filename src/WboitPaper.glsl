/** \file OITRenderer_writePixel.glsl
...
void writePixel
   (Radiance3   premultipliedReflectionAndEmission,     // color (transparent pixel we wantt to draw)
    float       coverage,                               // color.a
    Color3      transmissionCoefficient,                // transmit (existing opaque layer color)
    float       collimation,
    float       etaRatio,
    Point3      csPosition,
    Vector3     csNormal) {
